...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      <h2 className="text-2xl font-bold mb-6 text-gray-900">Profile Details</h2>
        ...
        <div className="relative">
          ...
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            >
              ...
              />
              <path
                d="M2 3.5H14V12.5C14 12.6326 13.9473 12.7598 13.8536 12.8536C13.7598 12.9473 13.6326 13 13.5 13H2.5C2.36739 13 2.24021 12.9473 2.14645 12.8536C2.05268 12.7598 2 12.6326 2 12.5V3.5Z"
                stroke="#737373"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
